...
## Data is read from a file athleteHeight


import tkinter

class HealthCalculatorGUI:
    def load_height_data(self, athleteHeight):
        # Loads athlete height data from a file called athleteHeight and stores in the dictionary self.dict1
        self.dict1 = {}
        with open(athleteHeight, 'r') as file:
            for line in file:
                parts = line.strip().split(',')
                if len(parts) == 2:
                    self.dict1[parts[0]] = parts[1]
    ...
    def __init__(self, height_data_file):
        
        self.load_height_data(height_data_file)
        ...
        self.player_entry=tkinter.Entry(self.main_window, width = 7)
        self.player_entry.grid(row = 0, column = 3)
        
        self.weight_label = tkinter.Label(self.main_window, text = "Enter athlete's weight: ")
        ...
        self.MHR_label = tkinter.Label (self.main_window, text = "Enter maximum heart rate: ")
        ...
        self.RHR_label = tkinter.Label(self.main_window, text = "Enter resting heart rate: ")
...
def main():        
    if __name__ == "__main__":
        calculator = HealthCalculatorGUI('athleteHeight.txt')
main()
